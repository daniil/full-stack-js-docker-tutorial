...
So we can't simply make a request to our API at `http://localhost:5050` from our React container, because inside of that container `localhost` refers to the container itself.
